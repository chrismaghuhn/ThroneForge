...
- Final current-head hosted run [30996787474](https://github.com/chrismaghuhn/ThroneForge/actions/runs/30996787474) validated commit `64b4a95f2d326eecdb3541c8ba6b8d84e22bd23e`; Windows and Ubuntu each uploaded 13 TRX files representing 272 tests, with 0 failures/errors/skips and SDK `10.0.100`. Both artifacts were downloaded and parsed independently.
