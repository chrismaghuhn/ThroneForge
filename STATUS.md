...
- Hosted validation: pending for the hardening branch. The final entry must record the current head, Windows/Linux SDK `10.0.100`, TRX counts, aggregate tests, and artifact inspection.
