...
- Status: Provisional recommendation recorded during M1 task 2
- Date: 2026-08-03
...
These are discovery recommendations only. Production game-facing target frameworks, loader dependencies, Harmony selection, lifecycle bindings, and runtime APIs remain unselected. All recommendations are provisional until a clean-profile loader smoke test succeeds.
