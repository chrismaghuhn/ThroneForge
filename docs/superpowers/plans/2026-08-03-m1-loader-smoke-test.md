...
- [ ] **Step 2: Replace stale Task-2 branch wording**
...
- [ ] **Step 3: Commit the scope-only documentation checkpoint**
...
- [ ] **Step 1: Add failing tests for root validation, archive validation, transaction state, and log parsing**
...
- [ ] **Step 2: Run the new focused tests and observe the expected missing-type failures**
...
- [ ] **Step 3: Add the two projects with no forbidden dependency**
...
- [ ] **Step 1: Make root-boundary tests pass**
...
- [ ] **Step 2: Make copy-manifest tests pass**
...
- [ ] **Step 3: Verify the focused copy tests**
...
- [ ] **Step 1: Add failing synthetic ZIP cases**
...
- [ ] **Step 2: Implement deterministic validation and extraction**
...
- [ ] **Step 3: Verify archive tests and digest determinism**
...
- [ ] **Step 2: Implement prepare/apply/verify/rollback**
...
- [ ] **Step 3: Verify transaction safety**
...
- [ ] **Step 1: Add failing launch/parser/report tests**
...
- [ ] **Step 2: Implement bounded launch observation**
...
- [ ] **Step 3: Implement sanitized log parsing and atomic report writing**
...
- Test: `tests/ThroneForge.LoaderSmokeTest.Tests/SmokeTestOrchestratorTests.cs`
...
- [ ] **Step 1: Run all local synthetic checks before touching the game**
...
- [ ] **Step 2: Verify official release metadata**
...
- [ ] **Step 3: Execute only against the disposable copy**
...
- [ ] **Step 1: Run exact local validation available on the host**
...
- [ ] **Step 2: Push and inspect hosted CI**
